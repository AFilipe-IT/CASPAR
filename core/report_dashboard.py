...
def _build_detail_html(g, av_rat, au_rat, detected_version=None):
...
def generate_dashboard(result, resolved=None):
  ...
  <div class="hero-info">
    <div class="hero-title"><h1>Security Configuration Audit</h1><div class="target">{_e(result.target_name)}</div></div>
    <div class="hero-grid">
...
'''
    ...
    return (
        ...
        + hero + cards + charts + table + chains_section +
