...
Uso:
    ...
    python3 -m plugins.apache_httpd.refresh_cve --db ccss.db

    # Ver o que mudaria sem escrever no banco
    python3 -m plugins.apache_httpd.refresh_cve --db ccss.db --dry-run

    # Forçar key específica (sobrepõe .env)
    python3 -m plugins.apache_httpd.refresh_cve --db ccss.db --nvd-key <key>
"""
...
from core.ccss import temporal_score
from core.cve_enricher import enrich_all, get_nvd_api_key
