"""
plugins/docker/__init__.py — GENERATED by `ccss plugin add`.

Edit this file to customise detection and metadata for Docker.
"""
...
from config_assessment.plugins.docker.parser import parse_file
from config_assessment.plugins.docker.rules import infer_profile

_FILENAMES = {'daemon.json'}


class DockerPlugin(Target):
    """Docker target plugin (CIS Docker Benchmark v1.8.0)."""
    ...
    def metadata(self) -> TargetMetadata:
        return TargetMetadata(
            ...
            display_name="Docker",
            version="1.0",
            benchmark_source="CIS Docker Benchmark v1.8.0",
            priority=100,
