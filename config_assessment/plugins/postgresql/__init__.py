"""
plugins/postgresql/__init__.py — GENERATED by `ccss plugin add`.

Edit this file to customise detection and metadata for PostgreSQL.
"""
...
from config_assessment.plugins.postgresql.parser import parse_file
from config_assessment.plugins.postgresql.rules import infer_profile

_FILENAMES = {'postgresql.conf'}


class PostgresqlPlugin(Target):
    """PostgreSQL target plugin (CIS PostgreSQL 13 Benchmark v1.3.0)."""
    ...
    def metadata(self) -> TargetMetadata:
        return TargetMetadata(
            ...
            version="1.0",
            benchmark_source="CIS PostgreSQL 13 Benchmark v1.3.0",
            priority=100,
...
register_plugin(PostgresqlPlugin())
